...
This example is based of an [article on hackernews](https://hackernoon.com/animated-page-transitions-with-react-router-4-reacttransitiongroup-and-animated-1ca17bd97a1a). I just updated it so that it is compatible with react-transition-group v2.2 and also cleaned up the code a little bit.
